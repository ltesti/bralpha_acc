...
def plot_ratio(names, r, er, rm, erm, filefig=None, maxrelerr=3., maxratio=3., mycol='red', myline="F$_{Br\alpha}$"):
    """
    ...
    ax.fill_between(names, r*0.0+rm+erm, r*0.0+rm-erm, color=mycol, alpha=0.3)
    ...
    ax.set_ylabel(r'{0} / FBrg'.format(myline))
    if filefig:
        fig.savefig(filefig)
